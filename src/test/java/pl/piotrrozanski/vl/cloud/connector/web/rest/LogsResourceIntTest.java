package pl.piotrrozanski.vl.cloud.connector.web.rest;

import pl.piotrrozanski.vl.cloud.connector.VlccApp;
import pl.piotrrozanski.vl.cloud.connector.web.rest.vm.LoggerVM;
...
@SpringBootTest(classes = VlccApp.class)
